...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-company"></i> Crear Presupuestos
    </h1>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <x-form action="{{ route('presupuestos.store') }}">
                        ...
                        <div class="form-group  col-md-2">
                            ...
                            <input required="" type="number" min="0" class="form-control" name="year"
                                id="year" placeholder="0000" value="">
                        ...
                        <div class="form-group  col-md-12">
                            ...
                            <textarea name="supuesto" class="form-control"></textarea>
