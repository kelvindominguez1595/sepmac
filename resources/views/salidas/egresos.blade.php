...
@section('page_header')
    <h4 class=" page-title"> <i class="voyager-paper-plane"></i>Solicitud de compras</h4>
@stop
@section('css')
    <style>
        .btn.btn-primary {
...
@section('content')
    ...
    <div class="page-content edit-add container-fluid">
        ...
        <x-modal title="Nueva solicitud de egresos" idModal="modalegresos">
            <x-form id="formrealizar_solicitud">
                ...
                <div class="form-group  col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <select name="cuenta_id" id="cuenta_id" class="form-control">
                        ...
                        @foreach ($presupuestos->whereIn('id', [13, 12]) as $pres)
                            @foreach ($pres->partidas as $pa)
                                @foreach ($pa->partida_detalle->whereIn('partida_id', [44, 41]) as $pade)
                                    <option value="{{ $pade->id }}">{{ $pade->detalle }}
                                    </option>
                                @endforeach
                            @endforeach
                        @endforeach
            ...
            <div class="col-md-12 ">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalegresos">
                            Nueva solicitud de egresos
                        </button>
...
@section('javascript')
    ...
    <script src="{{ asset('js/egresos_create.js') }}"></script>
@stop
